...
they are not independently derived from archion dynamics in
...
archion dynamics in this paper. What Phase E therefore
...
hypothesis is model-dependent (it assumes that the archion's
...
on the 3D archion background. A plausible attribution (to be
...
for the self-interaction, $\Phi_c$ for the archion amplitude) that
...
the gauge kinetic term around the radially varying archion
