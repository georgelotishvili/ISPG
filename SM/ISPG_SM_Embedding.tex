...
\date{Version 5.0 (Companion appendix to the MASS paper)}
...
reproduced to $0.0006\%$, Sargent's law to $0.26\%$, and the
absolute $\tau$ mass to $0.4\%$. This hypothesis is model-dependent; the
