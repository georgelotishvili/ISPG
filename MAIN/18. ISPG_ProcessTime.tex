...
\end{equation}
In the active-existence reading, the same factor may be written as
\begin{equation}
  \mathcal{C}(z)
  =
...
\end{equation}
Here $\mathcal N_{\rm act,bg}$ is defined operationally through this ratio:
...
active-existence ratio in \eqref{eq:Nact_bg_app18} is a matter-standard
