...
are therefore of the same order-Hubble scale, confirming the
anti-diagonal structure of the duality table on purely dynamical
grounds without identifying $t_0$ with $H_0^{-1}$.
