...
\end{itemize}
The main theory then isolates genuinely new structure at 2PN order: the bi-conformal exponential refractive index $n=e^{-\phi}$ produces a structurally distinct 2PN Shapiro signature whose refractive sub-piece is derived exactly; the full 2PN coefficient (including bent-ray and path-length contributions) is an open task and is developed in Appendix~6.
...
Light deflection and perihelion precession appendices rely on \eqref{eq:gamma1}; Shapiro 1PN relies on $\gamma=1$; the 2PN Shapiro structure (refractive sub-piece derived; bent-ray and path-length contributions open) is developed in Appendix~6.\\
\bottomrule
\end{tabular}
\end{center}
