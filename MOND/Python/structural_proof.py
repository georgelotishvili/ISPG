...
def derivation_chain():
    ...
    print("    After:  Omega_tr = a0/c is derived within the")
    print("            bifurcation/coherence-boundary closure")
    print()
...
if __name__ == "__main__":
    ...
    if ISSUES:
        ...
        print("  NO ALGEBRAIC ERRORS IN THE CLOSURE CHECKS.")
        print("  Full rotating-PDE/action derivation of the transport ansatz remains open.")
        print()
        ...
        print("    Status: Omega_tr = a0/c derived within the")
        print("            bifurcation/coherence-boundary closure")
        print("    Full action-to-PDE derivation remains the next theorem-level task")
